...
<head>
    ...
    <link rel="shortcut icon" href="<?=baseurl('public/adidas_yellow.ico')?>" type="image/x-icon"/>
...
<body>
    ...
    <nav class="light-blue lighten-1 text-space" role="navigation">
        <div class="nav-wrapper container"><a id="logo-container" href="<?=baseurl()?>" class="brand-logo">Adidas</a>
            <!-- Main Menu -->
    ...
    <footer class="page-footer orange">
        <div class="container">
            <div class="row">
                <div class="col l8 s12">
                    <h5 class="white-text text-space">Adidas Shopping Cart</h5>
                    <p class="grey-text text-lighten-4">This is simple Adidas Website for Shopping Cart</p>
                </div>
        ...
        <div class="footer-copyright">
            <div class="container">Adidas Shopping Cart © 2021</div>
        </div>
    </footer>
    <!--  Scripts-->
